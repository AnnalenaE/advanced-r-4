...
linreg <- setRefClass("linreg",
  ...
  methods = list(
    initialize = function(formula, data) {
      ...
      beta = (solve((t(X) %*% X)) %*% t(X) %*% y) ## Remember he told something about that solve doesn't always works, depends on the eigenvalues
      ...
      #customObject$pValues = pt(data, df, lower.tail = TRUE, log.p = FALSE)
